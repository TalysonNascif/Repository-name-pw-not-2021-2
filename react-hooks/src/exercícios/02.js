...
export default function Exercicio02({initialName = ''}) {
  ...
  const [name, setName] = React.useState(
    ...
    // Recuperação de um valor preciamente salvo no localStorage
    // ou usa o valor de initialName, caso o item do localStorge
    // não exista
  ...
  // Armazenamento em um item do localStorage chamado "name" o valor
  // da variável de estado name
    ...
    // do componente
    // 2) Vetor de dependências:nqual ou quais as variáveis de estado
