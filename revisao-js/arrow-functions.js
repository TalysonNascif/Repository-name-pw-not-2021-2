// Função tradicional com 1 parâmetro e 1 linha de código no cporto, com o return
function quadrado(x) {
    return x * x
}

// Arrow function equivalente
// 1) A função deve ser atribuida a uma variável (ou, melhor, uma constante)
// 2) Desaparece a palavra-chave 'function'
// 3) Desaparecem os parametros em torno do parâmetro
